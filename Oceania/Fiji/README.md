...
The social indicators presented use the latest available public datasets[^3]. For some countries and territories, data was not available; in those cases, existing values were retained where appropriate.
...
**Boundary data source:** United Nations Satellite Centre (UNOSAT), POPGIS, Fiji Islands Bureau of Statistics, Pacific Catastrophe Risk Assessment and Financing Initiative (PCRAFI)

**Publisher:** United Nations Satellite Centre (UNOSAT)

**Link:** https://unosat-geodrr.cern.ch/data/rest/services/Hosted/FJI_Admin_HDX/FeatureServer
...
[^3]: Social indicator sources include UN World Population Prospects 2024, UN National Accounts Main Aggregates Database, UNDP Human Development Report 2025, and World Bank Gini index data.
